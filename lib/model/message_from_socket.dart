...
class MessageFromSocket extends MessageModel{
  ...
  MessageFromSocket({String? topic, String? message, String? uuid, DateTime? timestamp, this.messageFromSocketType = MessageFromSocketType.none})
                  : super(topic: topic, message: message, uuid: uuid, timestamp: timestamp);
